...
class InternetArchiver(object):
	...
	def _process_cc(self, infile):
		...
		return {
			...
			'date' : metadata['date'].isoformat(), # TODO: This is just a string...need to make sure that Mongo recognizes this as a date object
			'time' : metadata['time'].isoformat(), # TODO: This is just a string...need to make sure that Mongo recognizes this as a time object
			'show': metadata['show'],
